...
import roslib; roslib.load_manifest('tefi_teleop')
import rospy
...
CTRL-C to quit
    ...
    def joy_callback(self, data):
        ...
        linear.x = data.axes[1] * self.speed
        linear.y = data.buttons[4] * data.axes[0] * self.speed
